...
const projectsData: Project[] = [
  ...
  },
  {
    ...
    description: 'A starter template for building RESTful APIs with Express.js and TypeScript',
  ...
  },
  {
    ...
    description: 'A complete authentication service built with Node.js, Express, and JWT',
  ...
  },
  {
    id: 6,
    name: 'Weather App',
    description: 'A weather application built with React that uses the OpenWeather API',
