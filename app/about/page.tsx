    ...
    <div className="container max-w-4xl py-12 md:py-24">
      ...
      <AnimatedSection delay={0.1} className="mt-12 space-y-6">
        <p className="text-lg">
          ...
          modern web applications using Next.js and Express.js. I specialize in creating responsive,
          performant, and user-friendly applications that solve real-world problems.
        </p>

        <p className="text-lg">
          With a strong foundation in JavaScript and TypeScript, I enjoy working across the entire
          stack, from designing intuitive user interfaces to implementing robust backend systems. My
          approach to development focuses on writing clean, maintainable code that delivers
          exceptional user experiences.
        </p>

        <p className="text-lg">
          When I'm not coding, I'm constantly learning about new technologies and best practices to
          stay at the forefront of web development. I believe in the power of open-source and
        ...
        <div className="space-y-8">
          ...
          <div className="relative pl-8 border-l border-muted">
            ...
            <div className="space-y-2">
              ...
              <p>
                Built responsive user interfaces using HTML, CSS, and JavaScript. Worked closely
                with designers to implement pixel-perfect designs.
              </p>
            </div>
          </div>
        </div>
